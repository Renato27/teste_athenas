...
namespace App\Services\Automations\Repositorios\Abstracts;

use App\Services\Automations\Repositorios\Contracts\CriarRepositorioService;
...
abstract class CriarRepositorioServiceAbstract implements CriarRepositorioService
{
     ...
     * @return string
     */
    private function getConteudoArquivo(string $caminho)
    {
